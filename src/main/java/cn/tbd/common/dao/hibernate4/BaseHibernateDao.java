package cn.tbd.common.dao.hibernate4;

import cn.tbd.common.dao.IBaseDao;
import cn.tbd.common.dao.util.ConditionQuery;
import cn.tbd.common.dao.util.OrderBy;
import cn.tbd.common.pagination.PageUtil;
import cn.tbd.common.util.Assert;
...
public abstract class BaseHibernateDao<M extends java.io.Serializable, PK extends java.io.Serializable> implements IBaseDao<M, PK> {
    ...
    public Session getSession() {
        //trasaction must be (Required), otherwise can get the session.
    ...
    /**
     * return unique result according the query.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Batch process. E.g.insert, update, delete.
     */
